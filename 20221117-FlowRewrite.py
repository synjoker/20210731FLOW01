...
class BOSdetect:
    ...
    def BlendView(self):
        ...
        cv2.putText(self.frame_blend, "mag=" + str(np.mean(self.mag)),
                    (0, 30), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 255, 255),
                    2)
        cv2.putText(self.frame_blend, "ang=" + str(np.mean(self.ang)),
                    (0, 60), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 255, 255),
                    2)
        cv2.imshow(
