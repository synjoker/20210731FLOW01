...
class Ui_MainWindow(QtWidgets.QWidget, Ui_MainWindow):
    ...
    def slot_init(self):
        self.button_open.clicked.connect(self.button_open_camera_clicked)  # 若该按键被点击，则调用button_open_camera_clicked()
